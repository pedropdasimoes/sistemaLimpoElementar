<template>
    <t-full-screen-card
        :bg-image="bgImage"
        :color="bgColor"
        :gradient-direction="bgGradientDirection"
    >
        <div :class="['relative', deviceType === 'phone' && 'w-11/12']">
            <!--Container-->
            <div :class="['auth-container', radiusStyle]">
                <!--Header-->
                <div :class="['auth-header', calculatedLoginStyle]">
                    <!--Logo-->
                    <div class="auth-logo">
                        <slot name="logo" />
                    </div>
            ...
            <div class="auth-error">
                <!--Errors-->
                <transition
                    @before-enter="beforeStyle"
                    @after-enter="enterStyle"
                >
                    <t-alert
                        v-if="hasErrors"
                        :radius="deviceType !== 'phone' && 5"
                        color="solid-red"
                    >
                        <template #icon>
